        ...
        public Ticket(final String[] cantidades, final String[] productos, final String[] precios, final String recibo) {
                ...
                try {
                        ...
                        for (byte i = 1; i < productos.length; i++) {
                                ...
                                datos[i] += Utilities.formatString("$" + Global.DFO00_0.format(Double.parseDouble(precios[i])), 7);
                                datos[i] += Utilities.formatString("$" + Global.DFO00_0.format(Double.parseDouble(total)), 7);
                        ...
                        if (Double.parseDouble(cambio) >= 0) {
                                ...
                                content[7] = "Total venta" + Utilities.separateStrings("Total venta", "$" + Global.DFO00_0.format(Double.parseDouble(precioFinal)), Global.TICKET_LENGTH);
                                content[8] = "Recibió" + Utilities.separateStrings("Recibio", "$" + Global.DFO00_0.format(Double.parseDouble(recibo)), Global.TICKET_LENGTH);
                                content[9] = "Cambio" + Utilities.separateStrings("Cambio", "$" + Global.DFO00_0.format(Double.parseDouble(cambio)), Global.TICKET_LENGTH);
